...
#FT8_K_index.py
# This script calculates the FT8 K index based on the provided data.
...
def main():
    ...
    sns.lineplot(x='DATE', y='K_INDEX', data=data, marker='o', label='K_INDEX', color='green',ax=ax)
    ...
    #plot K_INDEX  by month 
    sns.set_style("darkgrid")
    fig, ax = plt.subplots( figsize=(7, 3))
    sns.lineplot(x='MONTH', y='K_INDEX', data=data, marker='o', label='K_INDEX', color='yellow',ax=ax)
    plt.title(f'Monthly K_INDEX for year {year_type}', fontsize=10)
